...
I omitted printing the outputs for brevity. In summary, we see that we could see significance for the following predictors:
...
Luckily for this problem, we defined a function earlier in this homework assignment to generate cubic MLR functions. Let's put that to use again.
